...
root@ubuntu:/var/www/bigartist_backup_20260302_174903/server# cd /var/www/bigartist_backup_20260302_174903/server                             cd /var/www/bigartist_backup_20260302_174903/server
# Backup del server.js
# Backup del server.js.backup_csv_fix
cp server.js server.js.backup_csv_fix
# Cambiar 'file' por 'csv' en multer
# Cambiar 'file' por 'csv' en multeroad.single('csv')/g" server.js
sed -i "s/upload\.single('file')/upload.single('csv')/g" server.js
# Verificar el cambio
# Verificar el cambioado:"
echo "✅ Cambio aplicado:"rver.js
grep -n "upload.single" server.js
# Reiniciar PM2
# Reiniciar PM2
...
echo "📋 Logs del servidor:"es 15 --nostream
pm2 logs bigartist-api --lines 15 --nostream
✅ Cambio aplicado:
168:app.post('/api/royalties/import', authenticateToken, upload.single('csv'), async (req, res) => {
...
root@ubuntu:/var/www/bigartist_backup_20260302_174903/server# cat > /var/www/bigartist/src/pages/UploadPage.tsx << 'ARCHIVO_CORREGIDO'
> ^C
root@ubuntu:/var/www/bigartist_backup_20260302_174903/server# /var/www/bigartist/src/pages/UploadPage.tsx
-bash: /var/www/bigartist/src/pages/UploadPage.tsx: Permission denied
root@ubuntu:/var/www/bigartist_backup_20260302_174903/server# cd /var/www/bigartist
npm run build
...
error during build:
[vite]: Rollup failed to resolve import "sonner@2.0.3" from "/var/www/bigartist/src/components/Toaster.tsx".
This is most likely unintended because it can break your application at runtime.
If you do want to externalize this module explicitly add it to
`build.rollupOptions.external`
    at viteLog (file:///var/www/bigartist/node_modules/vite/dist/node/chunks/dep-DBxKXgDP.js:46345:15)
    at file:///var/www/bigartist/node_modules/vite/dist/node/chunks/dep-DBxKXgDP.js:46403:18
    at onwarn (file:///var/www/bigartist/node_modules/@vitejs/plugin-react/dist/index.js:76:7)
    at file:///var/www/bigartist/node_modules/vite/dist/node/chunks/dep-DBxKXgDP.js:46401:7
    at onRollupLog (file:///var/www/bigartist/node_modules/vite/dist/node/chunks/dep-DBxKXgDP.js:46393:5)
    at onLog (file:///var/www/bigartist/node_modules/vite/dist/node/chunks/dep-DBxKXgDP.js:46043:7)
    at file:///var/www/bigartist/node_modules/rollup/dist/es/shared/node-entry.js:20981:32
    at Object.logger [as onLog] (file:///var/www/bigartist/node_modules/rollup/dist/es/shared/node-entry.js:22968:9)
    at ModuleLoader.handleInvalidResolvedId (file:///var/www/bigartist/node_modules/rollup/dist/es/shared/node-entry.js:21712:26)
    at file:///var/www/bigartist/node_modules/rollup/dist/es/shared/node-entry.js:21670:26
root@ubuntu:/var/www/bigartist# # 1. Ir al directorio correcto
cd /var/www/bigartist/src/pages/

# 2. Backup del archivo actual
cp UploadPage.tsx UploadPage.tsx.backup_$(date +%Y%m%d_%H%M%S)

# 3. Crear el archivo corregido (SIN sonner@2.0.3, solo 'sonner')
cat > UploadPage.tsx << 'EOF'
import { Upload, FileText, AlertCircle, CheckCircle } from 'lucide-react';
import { useState, useRef } from 'react';
...
export function UploadPage() {
  ...
  const handleDragOver = (e: React.DragEvent) => {
echo "🎉 ¡LISTO! Prueba ahora en https://app.bigartist.es/upload"',r: '#c9a574' 

✅ Archivo creado. Verificando import de 'sonner':
import { toast } from 'sonner';
...
🎉 ¡LISTO! Prueba ahora en https://app.bigartist.es/upload
